#!/usr/bin/zsh
# udisksctl mount/unmount shortcuts with device-name completion. zsh-specific
# (compdef/_describe), hence the .zsh module. Provided by the udisks2 package.
load-udisksctl() {
    ensure-pkg udisksctl udisks2 || return
